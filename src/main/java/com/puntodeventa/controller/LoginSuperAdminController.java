...
@Controller
public class LoginSuperAdminController implements Initializable {
    ...
    private void iniciarSesion(ActionEvent event) throws IOException{
    	try
    	{
    		Usuario currentUsuario = usuarioService.autenticar(getCedula(), getContrasenia(), TipoUsuario.SUPER_ADMINISTRADOR);
